...
(function() {
  ...
  Formwatcher = {
    ...
    scanDocument: function() {
      ...
      handleForm = function(form) {
        ...
        if (domOptions) {
          options = deepExtend(options, domOptions);
        }
  ...
  Watcher = (function() {
    ...
    function Watcher(form, options) {
      ...
      submitButtons = $("input[type=submit], button[type=''], button[type='submit']", this.form);
    ...
    Watcher.prototype.enableForm = function() {
      return $(inputSelector, this.form).attr("disabled", false);
    };

    Watcher.prototype.disableForm = function() {
      return $(inputSelector, this.form).attr("disabled", true);
    };
