...
if((typeof Control !== 'undefined') || (typeof Control.ColorPicker !== 'undefined'))
{
  ...
  var ColorPicker = Class.create(Formwatcher.Decorator,
  {
    ...
    // Todo: write Formwatcher.addDecorator, which accepts an object, and makes
    // all the calls below itself.
    // This would then look like this: Formwatcher.addDecorator({ accepts: .... });
