...
/*!
    ...
    */
;!function(b,c){typeof a!="undefined"?a.exports=c():typeof define=="function"&&typeof define.amd=="object"?define(c):this[b]=c()}("domready",function(a){function m(a){l=1;while(a=b.shift())a()}var b=[],c,d=!1,e=document,f=e.documentElement,g=f.doScroll,h="DOMContentLoaded",i="addEventListener",j="onreadystatechange",k="readyState",l=/^loade|c/.test(e[k]);e[i]&&e[i](h,c=function(){e.removeEventListener(h,c,d);m()},d);g&&e.attachEvent(j,c=function(){if(/^c/.test(e[k])){e.detachEvent(j,c);m()}});return a=g?function(c){self!=top?l?c():b.push(c):function(){try{f.doScroll("left")}catch(b){return setTimeout(function(){a(c)},50)}c()}()}:function(a){l?a():b.push(a)}});provide("domready",a.exports);!function(a){var b=require("domready");a.ender({domReady:b});a.ender({ready:function(a){b(a);return this}},!0)}(ender)})();(function(){var a={exports:{}},b=a.exports;(function(){var a,b,c,d,e=[].slice,f={}.hasOwnProperty,g=function(a,b){function d(){this.constructor=a}for(var c in b)f.call(b,c)&&(a[c]=b[c]);d.prototype=b.prototype;a.prototype=new d;a.__super__=b.prototype;return a};c=function(){var a,b,d,g,h,i,j;d=arguments[0],a=2<=arguments.length?e.call(arguments,1):[];if(d==null)return{};for(i=0,j=a.length;i<j;i++){g=a[i];for(b in g){if(!f.call(g,b))continue;h=g[b];d[b]==null||typeof h!="object"?d[b]=h:d[b]=c(d[b],h)}}return d};$.ender({fwData:function(a,b){var c;this.data("_formwatcher")==null&&this.data("_formwatcher",{});if(a==null)return this;c=this.data("_formwatcher");if(b!=null){c[a]=b;this.data("_formwatcher",c);return this}return c[a]}},!0);d="input, textarea, select, button";a={version:"2.1.1",debugging:!1,debug:function(){if(this.debugging&&(typeof console!=="undefined"&&console!==null?console.debug:void 0)!=null)return console.debug.apply(console,arguments)},getErrorsElement:function(a,b){var c,d;d=a.input;d.attr("name")&&(c=$("#"+d.attr("name")+"-errors"));(c!=null?c.length:void 0)||!d.attr("id")||(c=$("#"+d.attr("id")+"-errors"));if(!c||!c.length){c=$.create("<span />");d.attr("name")&&c.attr("id",d.attr("name")+"-errors");c.insertAfter(d)}c.hide().addClass("errors").addClass("fw-errors");return c},getLabel:function(a,b){var c,d;c=a.input;d=void 0;if(c.attr("id")){d=$("label[for="+c.attr("id")+"]");d.length||(d=undefined)}if(!d&&b){d=c.previous();window.testinput=c;if(!d.length||d.get(0).nodeName!=="LABEL"||d.attr("for")!=null)d=void 0}return d},changed:function(b,c){var d;d=b.input;if(!d.fwData("forceValidationOnChange")&&d.attr("type")==="checkbox"&&d.fwData("previouslyChecked")===!!d[0].checked||d.fwData("previousValue")===d.val())return;d.fwData("forceValidationOnChange",!1);this.setPreviousValueToCurrentValue(b);d.attr("type")==="checkbox"&&d.fwData("initialyChecked")!==!!d[0].checked||d.attr("type")!=="checkbox"&&d.fwData("initialValue")!==d.val()?a.setChanged(b,c):a.unsetChanged(b,c);if(c.options.validate)return c.validateElements(b)},setChanged:function(b,c){var d,e,g;g=b.input;if(g.fwData("changed"))return;for(e in b){if(!f.call(b,e))continue;d=b[e];d.addClass("changed")}g.fwData("changed",!0);c.options.submitUnchanged||a.restoreName(b);if(c.options.submitOnChange&&c.options.ajax)return c.submitForm()},unsetChanged:function(b,c){var d,e,g;g=b.input;if(!g.fwData("changed"))return;for(e in b){if(!f.call(b,e))continue;d=b[e];d.removeClass("changed")}g.fwData("changed",!1);if(!c.options.submitUnchanged)return a.removeName(b)},storeInitialValue:function(a){var b;b=a.input;b.attr("type")==="checkbox"?b.fwData("initialyChecked",!!b[0].checked):b.fwData("initialValue",b.val());return this.setPreviousValueToInitialValue(a)},restoreInitialValue:function(a){var b;b=a.input;b.attr("type")==="checkbox"?b.attr("checked",b.fwData("initialyChecked")):b.val(b.fwData("initialValue"));return this.setPreviousValueToInitialValue(a)},setPreviousValueToInitialValue:function(a){var b;b=a.input;return b.attr("type")==="checkbox"?b.fwData("previouslyChecked",b.fwData("initialyChecked")):b.fwData("previousValue",b.fwData("initialValue"))},setPreviousValueToCurrentValue:function(a){var b;b=a.input;return b.attr("type")==="checkbox"?b.fwData("previouslyChecked",!!b[0].checked):b.fwData("previousValue",b.val())},removeName:function(a){var b;b=a.input;if(b.attr("type")==="checkbox")return;b.fwData("name")||b.fwData("name",b.attr("name")||"");return b.attr("name","")},restoreName:function(a){var b;b=a.input;if(b.attr("type")==="checkbox")return;return b.attr("name",b.fwData("name"))},decorators:[],decorate:function(b,c){var d,e,f,g,h;e=null;h=b.decorators;for(f=0,g=h.length;f<g;f++){d=h[f];if(d.accepts(c)){e=d;break}}if(e){a.debug('Decorator "'+e.name+'" found for input field "'+c.attr("name")+'".');return e.decorate(c)}return{input:c}},validators:[],currentWatcherId:0,watchers:[],add:function(a){return this.watchers[a.id]=a},get:function(a){return this.watchers[a]},getAll:function(){return this.watchers},scanDocument:function(){var d,e,f;e=function(d){var e,f,g;d=$(d);if(d.fwData("watcher"))return;f=d.attr("id");g=f!=null&&a.options[f]!=null?a.options[f]:{};e=d.data("fw");e&&(g=c(g,JSON.parse(e)));return new b(d,g)};$('form[data-fw], form[data-fw=""]').each(function(a){return e(a)});f=[];for(d in a.options)f.push(e($("#"+d)));return f},watch:function(a,c){return $.domReady(function(){return new b(a,c)})}};a._ElementWatcher=function(){function a(a){var b;this.watcher=a;this.options=c({},this.defaultOptions,(b=a.options[this.name])!=null?b:{})}a.name="_ElementWatcher";a.prototype.name="No name";a.prototype.description="No description";a.prototype.nodeNames=null;a.prototype.classNames=[];a.prototype.defaultOptions={};a.prototype.options=null;a.prototype.accepts=function(a){var b,c,d,e,f,g,h,i,j,k,l;if(this.watcher.options[this.name]!=null&&this.watcher.options[this.name]===!1)return!1;d=!1;e=a.get(0).nodeName;k=this.nodeNames;for(g=0,i=k.length;g<i;g++){f=k[g];if(e===f){d=!0;break}}if(!d)return!1;c=!0;l=this.classNames;for(h=0,j=l.length;h<j;h++){b=l[h];if(!a.hasClass(b)){c=!1;break}}return c};return a}();a.Decorator=function(a){function b(){return b.__super__.constructor.apply(this,arguments)}g(b,a);b.name="Decorator";b.prototype.decorate=function(a,b){return{input:b}};return b}(a._ElementWatcher);a.Validator=function(a){function b(){return b.__super__.constructor.apply(this,arguments)}g(b,a);b.name="Validator";b.prototype.nodeNames=["INPUT","TEXTAREA","SELECT"];b.prototype.validate=function(a,b){return!0};b.prototype.sanitize=function(a){return a};return b}(a._ElementWatcher);a.defaultOptions={ajax:!1,ajaxMethod:null,validate:!0,submitOnChange:!1,submitUnchanged:!0,submitFormIfAllUnchanged:!1,resetFormAfterSubmit:!1,automatchLabel:!0,responseCheck:function(a){return!a},onSubmit:function(){},onSuccess:function(a){},onError:function(a){return alert(a)}};a.options={};b=function(){function b(b,e){var f,g,h,i,j,k,l,m,n,o,p,q=this;this.form=typeof b=="string"?$("#"+b):$(b);if(this.form.length<1)throw"Form element not found.";if(this.form.length>1)throw"More than one form was found.";if(this.form.get(0).nodeName!=="FORM")throw"The element was not a form.";this.allElements=[];this.id=a.currentWatcherId++;a.add(this);this.observers={};this.form.fwData("watcher",this);this.form.fwData("originalAction",this.form.attr("action")||"").attr("action","javascript:undefined;");this.options=c({},a.defaultOptions,e||{});this.decorators=[];this.validators=[];n=a.decorators;for(j=0,l=n.length;j<l;j++){f=n[j];this.decorators.push(new f(this))}o=a.validators;for(k=0,m=o.length;k<m;k++){g=o[k];this.validators.push(new g(this))}this.options.ajaxMethod===null&&(this.options.ajaxMethod=(p=this.form.attr("method"))!=null?p.toLowerCase():void 0);switch(this.options.ajaxMethod){case"post":case"put":case"delete":break;default:this.options.ajaxMethod="get"}this.observe("submit",this.options.onSubmit);this.observe("success",this.options.onSuccess);this.observe("error",this.options.onError);$(d,this.form).each(function(b){var c,d,e,f,g,h,i,j,k,l,m,n;b=$(b);if(!b.fwData("initialized")){if(b.attr("type")==="hidden")return b.fwData("forceSubmission",!0);d=a.decorate(q,b);if(d.input.get()!==b.get()){d.input.attr("class",b.attr("class"));b=d.input}if(!d.label){g=a.getLabel(d,q.options.automatchLabel);g&&(d.label=g)}if(!d.errors){e=a.getErrorsElement(d,!0);d.errors=e}q.allElements.push(d);b.fwData("validators",[]);m=q.validators;for(k=0,l=m.length;k<l;k++){j=m[k];if(j.accepts(b,q)){a.debug('Validator "'+j.name+'" found for input field "'+b.attr("name")+'".');b.fwData("validators").push(j)}}a.storeInitialValue(d);if(b.val()===null||!b.val())for(f in d){c=d[f];c.addClass("empty")}q.options.submitUnchanged||a.removeName(d);h=function(){return a.changed(d,q)};i=function(){return q.validateElements(d,!0)};n=[];for(f in d){c=d[f];n.push(function(a){var b=this;a.on("focus",function(){return a.addClass("focus")});a.on("blur",function(){return a.removeClass("focus")});a.on("change",h);a.on("blur",h);return a.on("keyup",i)}(c))}return n}});i=$("input[type=submit], button[type=''], button[type='submit'], button:not([type])",this.form);h=$.create('<input type="hidden" name="" value="" />');this.form.append(h);i.each(function(a){a=$(a);return a.click(function(b){h.attr("name",a.attr("name")||"").attr("value",a.attr("value")||"");q.submitForm();return b.stopPropagation()})})}b.name="Watcher";b.prototype.callObservers=function(){var a,b,c,d,f,g,h;b=arguments[0],a=2<=arguments.length?e.call(arguments,1):[];g=this.observers[b];h=[];for(d=0,f=g.length;d<f;d++){c=g[d];h.push(c.apply(this,a))}return h};b.prototype.observe=function(a,b){this.observers[a]===undefined&&(this.observers[a]=[]);this.observers[a].push(b);return this};b.prototype.stopObserving=function(a,b){var c;this.observers[a]=function(){var d,e,f,g;f=this.observers[a];g=[];for(d=0,e=f.length;d<e;d++){c=f[d];c!==b&&g.push(c)}return g}.call(this);return this};b.prototype.enableForm=function(){return $(d,this.form).removeAttr("disabled")};b.prototype.disableForm=function(){return $(d,this.form).attr("disabled","disabled")};b.prototype.submitForm=function(a){var b=this;if(!this.options.validate||this.validateForm()){this.callObservers("submit");if(this.options.ajax){this.disableForm();return this.submitAjax()}this.form.attr("action",this.form.fwData("originalAction"));setTimeout(function(){b.form.submit();return b.disableForm()},1);return!1}};b.prototype.validateForm=function(){var a,b,c,d,e;b=!0;e=this.allElements;for(c=0,d=e.length;c<d;c++){a=e[c];this.validateElements(a)||(b=!1)}return b};b.prototype.validateElements=function(b,c){var d,e,g,h,i,j,k,l,m,n,o,p,q;g=b.input;i=!0;if(g.fwData("validators").length){if(!c||!g.fwData("lastValidatedValue")||g.fwData("lastValidatedValue")!==g.val()){g.fwData("lastValidatedValue",g.val());a.debug("Validating input "+g.attr("name"));g.fwData("validationErrors",[]);p=g.fwData("validators");for(l=0,n=p.length;l<n;l++){k=p[l];if(g.val()===""&&k.name!=="Required"){a.debug("Validating "+k.name+". Field was empty so continuing.");continue}a.debug("Validating "+k.name);j=k.validate(k.sanitize(g.val()),g);if(j!==!0){i=!1;g.fwData("validationErrors").push(j);break}}if(i){b.errors.html("").hide();for(e in b){if(!f.call(b,e))continue;d=b[e];d.addClass("validated");d.removeClass("error")}c&&b.input.fwData("forceValidationOnChange",!0)}else{for(e in b){if(!f.call(b,e))continue;d=b[e];d.removeClass("validated")}if(!c){b.errors.html(g.fwData("validationErrors").join("<br />")).show();for(e in b){if(!f.call(b,e))continue;d=b[e];d.addClass("error")}}}}if(!c&&i){h=g.fwData("lastValidatedValue");q=g.fwData("validators");for(m=0,o=q.length;m<o;m++){k=q[m];h=k.sanitize(h)}g.val(h)}}else for(e in b){if(!f.call(b,e))continue;d=b[e];d.addClass("validated")}return i};b.prototype.submitAjax=function(){var b,c,e,f=this;a.debug("Submitting form via AJAX.");c={};b=0;e=0;$(d,this.form).each(function(a,d){var e,g;a=$(a);if(a[0].nodeName==="BUTTON"||a[0].nodeName==="INPUT"&&(a.attr("type").toLowerCase()==="submit"||a.attr("type").toLowerCase()==="button"))return;if(a.fwData("forceSubmission")||a.attr("type")==="checkbox"||a.fwData("changed")||f.options.submitUnchanged)if(a.attr("type")!=="checkbox"||a.get(0).checked){b++;e=(g=a.attr("name"))!=null?g:"unnamedInput_"+d;return c[e]=a.val()}});return b===0&&!this.options.submitFormIfAllUnchanged?setTimeout(function(){f.enableForm();return f.ajaxSuccess()},1):$.ajax({url:this.form.fwData("originalAction"),method:this.options.ajaxMethod,data:c,type:"text",error:function(a){return f.callObservers("error",a.response)},success:function(a){f.enableForm();if(!f.options.responseCheck(a.response))return f.callObservers("error",a.response);f.callObservers("success",a.response);return f.ajaxSuccess()}})};b.prototype.ajaxSuccess=function(){var b,c,d,e,f,g,h,i;h=this.allElements;i=[];for(f=0,g=h.length;f<g;f++){c=h[f];a.unsetChanged(c,this);this.options.resetFormAfterSubmit?a.restoreInitialValue(c):a.storeInitialValue(c);e=c.input.val()===null||!c.input.val();i.push(function(){var a;a=[];for(d in c){b=c[d];e?a.push(b.addClass("empty")):a.push(b.removeClass("empty"))}return a}())}return i};return b}();if(typeof window!="undefined"&&window!==null){window.Formwatcher=a;window.Watcher=b}$.domReady(function(){return a.scanDocument()})}).call(this);(function(){var a,b={}.hasOwnProperty,c=function(a,c){function e(){this.constructor=a}for(var d in c)b.call(c,d)&&(a[d]=c[d]);e.prototype=c.prototype;a.prototype=new e;a.__super__=c.prototype;return a};a=function(a){return a.replace(/^\s.*\s$/,"")};Formwatcher.validators.push(function(b){function d(){return d.__super__.constructor.apply(this,arguments)}c(d,b);d.prototype.name="Integer";d.prototype.description="Makes sure a value is an integer";d.prototype.classNames=["validate-integer"];d.prototype.validate=function(a){return a.replace(/\d*/,"")!==""?"Has to be a number.":!0};d.prototype.sanitize=function(b){return a(b)};return d}(Formwatcher.Validator));Formwatcher.validators.push(function(b){function d(){return d.__super__.constructor.apply(this,arguments)}c(d,b);d.prototype.name="Required";d.prototype.description="Makes sure the value is not blank (nothing or spaces).";d.prototype.classNames=["required"];d.prototype.validate=function(b,c){return c.attr("type")==="checkbox"&&!c.is(":checked")||!a(b)?"Can not be blank.":!0};return d}(Formwatcher.Validator));Formwatcher.validators.push(function(a){function b(){return b.__super__.constructor.apply(this,arguments)}c(b,a);b.prototype.name="NotZero";b.prototype.description="Makes sure the value is not 0.";b.prototype.classNames=["not-zero"];b.prototype.validate=function(a){var b;b=parseInt(a);return!isNaN(b)&&b===0?"Can not be 0.":!0};return b}(Formwatcher.Validator));Formwatcher.validators.push(function(b){function d(){return d.__super__.constructor.apply(this,arguments)}c(d,b);d.prototype.name="Email";d.prototype.description="Makes sure the value is an email.";d.prototype.classNames=["validate-email"];d.prototype.validate=function(a){var b;b=/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return a.match(b)?!0:"Must be a valid email address."};d.prototype.sanitize=function(b){return a(b)};return d}(Formwatcher.Validator));Formwatcher.validators.push(function(b){function d(){return d.__super__.constructor.apply(this,arguments)}c(d,b);d.prototype.name="Float";d.prototype.description="Makes sure a value is a float";d.prototype.classNames=["validate-float"];d.prototype.defaultOptions={decimalMark:","};d.prototype.validate=function(a){var b;b=new RegExp("\\d+(\\"+this.options.decimalMark+"\\d+)?");return a.replace(b,"")!==""?"Has to be a number.":!0};d.prototype.sanitize=function(b){b.indexOf(".")>=0&&b.indexOf(",")>=0&&(b.lastIndexOf(",")>b.lastIndexOf(".")?b=b.replace(/\./g,""):b=b.replace(/\,/g,""));b.indexOf(",")>=0&&(b=b.replace(/\,/g,"."));b.indexOf(".")!==b.lastIndexOf(".")&&(b=b.replace(/\./g,""));b=b.replace(/\./g,this.options.decimalMark);return a(b)};return d}(Formwatcher.Validator))}).call(this);provide("formwatcher",a.exports)})();(function(){var a={exports:{}},b=a.exports;(function(){var a={}.hasOwnProperty,b=function(b,c){function e(){this.constructor=b}for(var d in c)a.call(c,d)&&(b[d]=c[d]);e.prototype=c.prototype;b.prototype=new e;b.__super__=c.prototype;return b};Formwatcher.decorators.push(function(a){function c(){return c.__super__.constructor.apply(this,arguments)}b(c,a);c.prototype.name="Hint";c.prototype.description="Displays a hint in an input field.";c.prototype.nodeNames=["INPUT","TEXTAREA"];c.prototype.defaultOptions={auto:!0,removeTrailingColon:!0,color:"#aaa"};c.prototype.decParseInt=function(a){return parseInt(a,10)};c.prototype.accepts=function(a){if(c.__super__.accepts.call(this,a))if(a.data("hint")!=null||this.options.auto&&Formwatcher.getLabel({input:a},this.watcher.options.automatchLabel))return!0;return!1};c.prototype.decorate=function(a){var b,c,d,e,f,g,h,i,j,k,l,m,n=this;d={input:a};f=a.data("hint");if(f==null||!f){i=Formwatcher.getLabel(d,this.watcher.options.automatchLabel);if(!i)throw"The hint was empty, but there was no label.";d.label=i;i.hide();f=i.html();this.options.removeTrailingColon&&(f=f.replace(/\s*\:\s*$/,""))}Formwatcher.debug("Using hint: "+f);m=$.create('<span style="display: inline-block; position: relative;" />');m.insertAfter(a);m.append(a);h={left:a[0].offsetLeft,top:a[0].offsetTop,width:a[0].offsetWidth,height:a[0].offsetHeight};j=this.decParseInt(a.css("paddingLeft"))+this.decParseInt(h.left)+this.decParseInt(a.css("borderLeftWidth"))+2+"px";l=this.decParseInt(a.css("paddingTop"))+this.decParseInt(h.top)+this.decParseInt(a.css("borderTopWidth"))+"px";g=$.create("<span />").html(f).css({position:"absolute",display:"none",top:l,left:j,fontSize:a.css("fontSize"),lineHeight:a.css("lineHeight"),fontFamily:a.css("fontFamily"),color:this.options.color}).addClass("hint").on("click",function(){return a[0].focus()}).insertAfter(a);e=100;a.focusin(function(){if(a.val()==="")return g.animate({opacity:.4,duration:e})});a.focusout(function(){if(a.val()==="")return g.animate({opacity:1,duration:e})});b=function(){return a.val()===""?g.show():g.hide()};a.keyup(b);a.keypress(function(){return setTimeout(function(){return b()},1)});a.keydown(function(){return setTimeout(function(){return b()},1)});a.change(b);k=10;c=function(){b();setTimeout(function(){return c()},k);k*=2;return k=k>1e4?1e4:k};c();return d};return c}(Formwatcher.Decorator))}).call(this);provide("formwatcher-hint",a.exports)})()