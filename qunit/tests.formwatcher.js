  ...
  Formwatcher.tests = function() {
    ...
    asyncTest("calls the right observers and sets appropriate classes", function() {
      ...
      watcher = new Watcher(form, {
        ajax: true,
        validate: false,
        responseCheck: function() {
          return false;
        },
        onSubmit: function() {
          return submitCalled1 = true;
        },
        onSuccess: function() {
          return successCalled1 = true;
        },
        onError: function() {
      ...
      watcher2 = new Watcher(form2, {
        ...
        onSubmit: function() {
          return submitCalled2 = true;
        },
        onSuccess: function() {
          return successCalled2 = true;
        },
        onError: function() {
          return errorCalled2 = true;
        },
        onComplete: function() {
          ok(submitCalled2, "Should have called onSubmit before.");
          ok(successCalled2, "Should have called onSuccess before.");
          ok(!errorCalled2, "Shouldn't have called onError before.");
          completed2 = true;
          if (completed1) {
            return start();
          }
